    ...
    <div>
      <section className="pt-120 pb-120 mt-10 mt-lg-0">
        <div className="container">
          ...
          <FadeDown>
            <div
              className="mx-auto py-4 py-md-5 border-top border-bottom"
          ...
          <div className="mx-auto mt-10" style={{ maxWidth: "850px" }}>
            <CommentsClient slug={String(blog.slug)} />
          </div>
        </div>
      </section>
      ...
      {blog.sections?.some((s: any) => s.videoId) && (
        <ModalVideo
          channel="youtube"
          youtube={{ mute: 0, autoplay: 0 }}
          isOpen={isOpen}
          videoId={blog.sections.find((s: any) => s.videoId)?.videoId}
