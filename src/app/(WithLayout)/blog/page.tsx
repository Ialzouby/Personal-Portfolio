  ...
  return (
    <div>
      <section className="banner-section-top pt-120 pb-60 mt-10 mt-lg-0 justify-content-center">
        ...
        <FadeDown>
          <div className="pb-60 br-bottom-n3 w-100">
            <div className="container">
              <div className="page-heading text-center d-flex flex-column align-items-center">
                ...
                <div className="d-flex flex-wrap flex-sm-nowrap gap-3 gap-md-6 justify-content-center">
                  <input
                    placeholder="Enter your email"
                    className="brn4 px-4 px-md-8 py-2 py-md-4 rounded-pill n5-color"
                  />
                  <button className="p-btn bg1-color fw-medium n11-color px-3 px-md-6 py-2 py-md-4 rounded-pill d-flex align-items-center gap-2 h-100 flex-shrink-0">
                    <PiPaperPlaneTilt />
                    Subscribe
                  </button>
                </div>
